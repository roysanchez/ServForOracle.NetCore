...
namespace ServForOracle.NetCore.UnitTests
{
    ...
    public class MetadataBuilderTests
    {
        ...
        [Theory, CustomAutoData]
        internal void GetMetadataOracleObject_NotInCache_CallsDb_Collection(OracleUdtInfo info, string schema, string objectName, string subObjectName, int[] propOrder, string[] propName)
        {
            var superType = typeof(SuperCollectionClass);
            var subtype = typeof(TestRoy);
            ...
            readerMoq.Setup(r => r.IsDBNull(2)).Returns(false);
            ...
            collectionReaderMoq.SetupSequence(r => r.Read())
                .Returns(true)
                .Returns(false);
            collectionReaderMoq.Setup(r => r.GetString(0)).Returns(schema);
            collectionReaderMoq.Setup(r => r.GetString(1)).Returns(subObjectName);
            ...
            var result = builder.GetOrRegisterMetadataOracleObject<SuperCollectionClass>(info);
        ...
        [Theory, CustomAutoData]
        internal void GetMetadataOracleObject_NotInCache_CallsDb_Collection_InvalidSub_Throws(OracleUdtInfo info, string schema, string objectName, int[] propOrder, string[] propName, string dataSource)
        {
            var superType = typeof(SuperCollectionClass);
            var subtype = typeof(TestRoy);
            ...
            cmdMoq.Setup(c => c._ExecuteDbDataReader(It.IsAny<CommandBehavior>()))
                .Returns(readerMoq.Object);

            readerMoq.Setup(r => r.Read())
                .Returns(true);
            ...
            collectionReaderMoq.Setup(r => r.Read())
                .Returns(false);
        ...
        [Theory, CustomAutoData]
        internal void GetMetadataOracleObject_TypeDefinitionInCache(MetadataOracleTypeDefinition metadataOracleType)
        {
            var readerMoq = new Mock<DbDataReader>();
            var info = metadataOracleType.UDTInfo;
            var properties = metadataOracleType.Properties.ToArray();
            ...
            var metadata = builder.GetOrRegisterMetadataOracleObject<TestRoy>(info);
        ...
        [Theory, CustomAutoData]
        internal void GetMetadataOracleObject_NoUdt_Object_InAttributeOrPreset(MetadataOracleTypeDefinition metadataOracleType)
        {
            var readerMoq = new Mock<DbDataReader>();
            var info = metadataOracleType.UDTInfo;
            var properties = metadataOracleType.Properties.ToArray();
            ...
            var metadata = builder.GetOrRegisterMetadataOracleObject<TestRoy>(null);
        ...
        [Theory, CustomAutoData]
        internal void GetMetadataOracleObject_NoUdt_Object_NotInAttributeOrPreset_ThrowsArgumentException(MetadataOracleTypeDefinition metadataOracleType)
        {
            var readerMoq = new Mock<DbDataReader>();
            var info = metadataOracleType.UDTInfo;
            var properties = metadataOracleType.Properties.ToArray();
            ...
            var exception = Assert.Throws<ArgumentException>(() => builder.GetOrRegisterMetadataOracleObject<TestRoy>(null));
